...
export function hasAdminRole(user: Pick<User, 'role'> | null | undefined) { return user?.role === 'ADMIN'; }
export function isAdmin() { return hasAdminRole(getStoredUser()) && isAuthenticated(); }
