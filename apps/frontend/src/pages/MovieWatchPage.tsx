    ...
    <main className="mx-auto max-w-[1500px] px-4 py-6">
      <div className="grid gap-7 xl:grid-cols-[minmax(0,1fr)_390px]">
        <section className="min-w-0">
          <VideoPlayer src={item.processedVideoUrl || item.videoUrl} originalSrc={item.originalVideoUrl} type={item.videoType} source={item.videoSource} poster={item.bannerUrl || item.posterUrl} movieId={item.id} />
